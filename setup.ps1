...
if (!(Test-Path -Path $PROFILE -PathType Leaf)) {
    try {
        ...
        Invoke-RestMethod https://github.com/timotofcourse/powershell-profile/raw/main/Microsoft.PowerShell_profile.ps1 -OutFile $PROFILE
...
# Font Install
Install-NerdFonts -FontName "Hack" -FontDisplayName "Hack Nerd Font"

# Final check and message to the user
if ((Test-Path -Path $PROFILE) -and (winget list --name "OhMyPosh" -e) -and ($fontFamilies -contains "Hack Nerd Font")) {
